...
if(isset($_POST['submit'])){
	...
	$obj->edit_school($_POST['school-short'],$_POST['school-full'],$_POST['udate'],$id);
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <input class="form-control" name="school-short" id="school_short"
                                                    value="<?php echo $res->school_short;?>" required="required"
                                                    onblur="schoolAvailability()">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <input class="form-control" name="school-full" id="school_full"
                                                    value="<?php echo $res->school_full;?>" required="required"
                                                    onblur="schoolfullAvail()">
