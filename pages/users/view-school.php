...
if (! (isset ( $_SESSION ['login'] ))) {
	...
	if(isset($_GET['del']))
    {
          ...
          $obj->del_school(intval($_GET['del']));
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php 
                                     ...
                                     while($res=$rs->fetch_object()){?>	
                                        <tr class="odd gradeX">
                                            <td><?php echo $sn?></td>
                                            <td><?php echo htmlentities( strtoupper($res->school_short));?></td>
                                            <td><?php echo htmlentities(strtoupper($res->school_full));?></td>
                                            <td><?php echo htmlentities($res->school_create_date);?></td>
                                             <td>&nbsp;&nbsp;<a href="edit-school.php?school_id=<?php echo htmlentities($res->school_id);?>"><p class="fa fa-edit"></p></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                             <a href="view-school.php?del=<?php echo htmlentities($res->school_id); ?>"> <p class="fa fa-times-circle"></p></td>
