    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> School<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="add-school.php">Add School</a>
                        </li>
                        <li>
                            <a href="view-school.php">View</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="register.php"><i class="fa fa-bar-chart-o fa-fw"></i>Regsiter<span
