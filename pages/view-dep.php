                                    ...
                                    <?php 
                                     ...
                                     while($res=$rs->fetch_object()){?>	
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php echo htmlentities(strtoupper($res->school_dep));?></td>
                                            <td>&nbsp;&nbsp;<a href="edit-sub.php?sid=<?php echo htmlentities($res->depid);?>"><p class="fa fa-edit"></p></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                             <a href="view-dep.php?del=<?php echo htmlentities($res->depid); ?>"> <p class="fa fa-times-circle"></p></td>
