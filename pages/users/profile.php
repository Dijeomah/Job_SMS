...
<!--nav-->
  ...
  <input class="form-control" name="school-short" id="school_short" required="required"  onblur="schoolAvailability()">       
		...
		<div class="col-lg-6">
		<input class="form-control" name="school-full" id="school_full" required="required"  onblur="schoolfullAvail()">         
